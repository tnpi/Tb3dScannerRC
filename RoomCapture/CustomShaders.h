...
class LightedWithPerVertexColorShader : public CustomShader
{
public:
...
protected:
    ...
    const char *vertexShaderSource ()
    {
        ...
        void main()
        {
            ...
            // Slightly reducing the effect of the lighting
            float v_luminance = 0.5*abs(vec.z) + 0.5;
            v_color = a_color *v_luminance;
        }
        )";
    }
...
class RGBATextureShader : public CustomShader
{
public:
    virtual void load ()
    {
    ...
    virtual void prepareRendering (const float *projection, const float *modelView, GLint textureUnit)
    {
        ...
        glUniform1i (_samplerLocation, textureUnit - GL_TEXTURE0);
    }
