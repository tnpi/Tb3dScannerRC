...
UIColor* const      blackLabelColorWithAlpha = [UIColor colorWithRed:0.0         green:0.0         blue:0.0        alpha:0.8];
...
- (void)applyCustomStyleWithBackgroundColor:(UIColor*)color {
    ...
    self.titleLabel.font = [UIFont fontWithName:@"ProximaNova-Regular" size:16.0];
